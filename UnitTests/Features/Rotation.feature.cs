...
namespace UnitTests.Features
{
    ...
    public partial class ПоворотОбъектаВокругСобственнойОсиFeature : object, Xunit.IClassFixture<ПоворотОбъектаВокругСобственнойОсиFeature.FixtureData>, System.IDisposable
    {
...
#line 1 "Rotation.feature"
#line hidden
        
        public ПоворотОбъектаВокругСобственнойОсиFeature(ПоворотОбъектаВокругСобственнойОсиFeature.FixtureData fixtureData, UnitTests_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("ru"), "Features", "Поворот объекта вокруг собственной оси", null, ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [Xunit.TraitAttribute("FeatureTitle", "Поворот объекта вокруг собственной оси")]
...
#line hidden
#line 14
testRunner.Then("возникает ошибка при повороте Exception", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Тогда ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                ПоворотОбъектаВокругСобственнойОсиFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                ПоворотОбъектаВокругСобственнойОсиFeature.FeatureTearDown();
            }
        }
    }
}
